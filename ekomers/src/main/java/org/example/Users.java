...
public class Users {
    ...
    public String getUsers(int usersId, String addedQuery){
        ...
        String querySQL = "";
        String queryAddress = "SELECT * FROM addresses WHERE id_user="+usersId;
        if (usersId == 0) {
            ...
            querySQL = "SELECT * FROM users WHERE id_user=" + usersId;
        }
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                jsonUSer.put("id", resultSet.getInt("id_user"));
